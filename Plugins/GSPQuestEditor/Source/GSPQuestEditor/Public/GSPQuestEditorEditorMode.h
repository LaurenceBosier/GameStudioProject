...
#include "GSPQuestEditorEditorMode.generated.h"
 ...
 */
UCLASS()
class UGSPQuestEditorEditorMode : public UEdMode
{
	GENERATED_BODY()

public:

	const static FEditorModeID EM_GSPQuestEditorEditorModeId;
	...
	UGSPQuestEditorEditorMode();


	virtual ~UGSPQuestEditorEditorMode();
